var NilaiImprProdukGolSchema = require('../models/nilaiImprProdukGolModel');
var Data = NilaiImprProdukGolSchema.data;
var Histogram = NilaiImprProdukGolSchema.histogram;
...
exports.updateAll = function(req, res) {
    req.jsonData.bulan = req.body.bulan;
    req.jsonData.golongan = req.body.golongan;
    req.jsonData.nilai_fob = req.body.nilai_fob;
