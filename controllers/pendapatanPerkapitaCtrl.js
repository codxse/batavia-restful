...
var PendapatanPerkapitaSchema = require('../models/pendapatanPerkapitaModel');
var Model = PendapatanPerkapitaSchema.linear;
var Data = PendapatanPerkapitaSchema.data;
...
exports.updateAllDataFields = function(req, res) {
    ...
    req.jsonData.perkapita_jakarta = req.body.perkapita_jakarta;
    req.jsonData.perkapita_nasional = req.body.perkapita_nasional;
