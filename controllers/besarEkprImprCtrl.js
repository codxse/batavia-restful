var BesarEkprImprSchema = require('../models/besarEkprImprModel');
var Data = BesarEkprImprSchema.data;
...
exports.updateAll = function(req, res) {
    ...
    req.jsonData.atribut = req.body.atribut;
    req.jsonData.juta_usd = req.body.juta_usd;
